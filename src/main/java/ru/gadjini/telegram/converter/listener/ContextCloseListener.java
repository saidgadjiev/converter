...
import ru.gadjini.telegram.converter.job.ConversionJobDelegate;
...
public class ContextCloseListener implements ApplicationListener<ContextClosedEvent> {
    ...
    private ConversionJobDelegate conversionJob;

    private FileManager fileManager;

    public ContextCloseListener(ConversionJobDelegate conversionJob, FileManager fileManager) {
