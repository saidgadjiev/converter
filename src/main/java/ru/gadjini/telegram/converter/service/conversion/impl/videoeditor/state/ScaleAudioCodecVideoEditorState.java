...
@Component
public class ScaleAudioCodecVideoEditorState implements VideoEditorState {

    private FFmpegVideoCommandPreparer videoStreamsChangeHelper;

    @Autowired
    public ScaleAudioCodecVideoEditorState(FFmpegVideoCommandPreparer videoStreamsChangeHelper) {
