    ...
    public ConversionResult doConvert(ConversionQueueItem fileQueueItem) {
        ...
        try {
            try {
                ...
                calibreDevice.convert(in.getAbsolutePath(), result.getAbsolutePath(), conversionProperties.getCalibreConversionTimeOut());
                ...
                try {
                    ...
                    calibreDevice.convert(outPdf.getAbsolutePath(), result.getAbsolutePath(),
                            conversionProperties.getCalibreConversionTimeOut(),
