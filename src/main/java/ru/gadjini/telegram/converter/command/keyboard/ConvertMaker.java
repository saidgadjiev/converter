...
public class ConvertMaker {
    ...
    public ConvertMaker(CommandStateService commandStateService, UserService userService,
                        ...
                        InlineKeyboardService inlineKeyboardService, FormatService formatService, ConversionFormatService conversionFormatService, FileManager fileManager, TempFileService fileService) {
