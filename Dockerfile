...
EXPOSE 8080
ENTRYPOINT ["java", "-Xss5m", "-Xmx2g", "-XX:+HeapDumpOnOutOfMemoryError", "-XX:HeapDumpPath=/home/bot/app/oom", "-jar", "app.jar"]
#ENTRYPOINT ["java", "-Xss5m", "-Xmx6g", "-jar", "-agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=*:5005", "app.jar"]
